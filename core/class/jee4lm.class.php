...
// now create standard commands
      $_eq->AddAction("jee4lm_on", "Machine ON", "jee4lm::main on off","button",1,"ENERGY_ON");
      $_eq->AddAction("jee4lm_off", "Machine OFF", "jee4lm::main on off","button",1,"ENERGY_OFF");
      $_eq->AddAction("jee4lm_steam_on", "Vapeur ON", "jee4lm::steam on off","button",1,"ENERGY_ON");
      $_eq->AddAction("jee4lm_steam_off", "Vapeur OFF", "jee4lm::steam on off","button",1,"ENERGY_OFF");
