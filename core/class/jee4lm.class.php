...
//              "text::td::3::3"=>"Chaudière à vapeur",
  ...
  public static function deamon_start() {
    ...
    $cmd .= ' --callback ' . network::getNetworkAccess('internal', 'http:'.JEEDOM_DAEMON_HOST.':port:comp') . '/plugins/template/core/php/jee4lmd.php'; // chemin de la callback url à modifier (voir ci-dessous)
